# A-Share Stock Timing Skill

[中文](./README.md)

`ashare-stock-timing` is a Codex Skill for AI agents that analyze Chinese A-share individual-stock technical timing: trend, buy points, sell points, fund-flow proxies, chip/cost distribution, and risk plans.
...
After that, Codex can invoke the skill when the user asks about A-share technical trends or buy/sell timing.
